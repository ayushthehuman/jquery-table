$(document).ready(function () {
  ...
  $(document).ready(function () {
    ...
    function checkData(id, name, price, qunty) {
      //checking data
    ...
    function addValue(id, name, price, qunty) {
      //add value in array
    ...
    function displayTble() {
      ...
      console.log("indiply");
      let html =
        "<table><tr><th>product id</th><th>product name</th><th>product price</th><th>Quantity</th><th>Action</th></tr>";
      for (let i = 0; i < data.length; i++) {
        console.log(i);
        html +=
          "<tr><td>" +
